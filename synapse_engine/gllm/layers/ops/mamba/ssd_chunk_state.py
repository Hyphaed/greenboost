...
#
# Vendored 2026-07-29 (import lines adapted only) from vllm/
# model_executor/layers/mamba/ops/ssd_chunk_state.py. See
# synapse_engine/NOTICE for the Mamba-2 SSD vendoring note.
...
from .mamba2_decode import softplus
